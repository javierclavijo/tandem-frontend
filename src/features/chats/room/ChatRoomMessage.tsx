...
function ChatRoomMessage(
  ...
  return (
    <div css={isOwnMessage ? ownMessageOuterCss : outerCss} ref={ref}>
      {!isOwnMessage ? <div css={speechBubbleOtherMessageCss} /> : null}
      <div css={isOwnMessage ? ownMessageCss : otherMessageCss}>
      ...
      {isOwnMessage ? <div css={speechBubbleOwnMessageCss} /> : null}
    </div>
  );
}
