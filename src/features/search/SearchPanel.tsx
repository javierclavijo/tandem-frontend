...
function SearchPanel({
  setUserSearchParams, setChannelSearchParams, searchType, setSearchType,
}: SearchPanelProps) {
  ...
  React.useEffect(() => {
    if (!areInitialValuesSet) {
      ...
      if (searchType === searchTypeOptions.USERS.value) {
        ...
        setNativeLanguages(languageOptions.filter((option) => searchParams.getAll('nativeLanguages').includes(option.value)));
        setLearningLanguages(languageOptions.filter((option) => searchParams.getAll('learningLanguages').includes(option.value)));
        const levels = levelOptions.filter((option) => searchParams.getAll('learningLanguagesLevels').includes(option.value));
        if (levels) {
        ...
        setChannelLanguages(languageOptions.filter((option) => searchParams.getAll('languages').includes(option.value)));
        setChannelLevels(levelOptions.filter((option) => searchParams.getAll('levels').includes(option.value)));
      }
